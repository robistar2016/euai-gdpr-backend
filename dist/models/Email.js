...
emailSchema.pre('save', function (next) {
    return __awaiter(this, void 0, void 0, function* () {
        if (this.isModified('email')) {
            ...
            this.email = yield bcrypt_1.default.hash(this.email, salt);
        }
        next();
    });
});
// Method to compare emails
emailSchema.methods.compareEmail = function (candidateEmail) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield bcrypt_1.default.compare(candidateEmail, this.email);
    });
};
